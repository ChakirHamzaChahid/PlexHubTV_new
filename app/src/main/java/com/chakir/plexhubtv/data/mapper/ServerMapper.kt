...
class ServerMapper @Inject constructor() {
    ...
    fun mapEntityToDomain(entity: ServerEntity): Server {
        ...
        return Server(
            ...
            port = entity.port,
            connectionUri = uri,
            connectionCandidates = listOf(
                com.chakir.plexhubtv.domain.model.ConnectionCandidate(
    ...
    fun mapDtoToDomain(resource: com.chakir.plexhubtv.data.model.PlexResource): Server? {
        ...
        return Server(
            ...
            connectionCandidates = connections.map { 
                com.chakir.plexhubtv.domain.model.ConnectionCandidate(
    ...
    fun mapDomainToEntity(server: Server): ServerEntity {
        val uri = try { java.net.URI(server.connectionUri) } catch (e: Exception) { null }
        return ServerEntity(
