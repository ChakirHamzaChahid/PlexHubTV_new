...
class WatchNextHelper @Inject constructor(
     ...
     */
    fun updateWatchNext(media: MediaItem, positionMs: Long, durationMs: Long) {
        ...
        try {
            ...
            Log.e("WatchNextHelper", "Error updating Watch Next channel", e)
        }
    }
    ...
    fun removeFromWatchNext(media: MediaItem) {
        try {
            ...
            Log.e("WatchNextHelper", "Error removing from Watch Next", e)
        }
    }
